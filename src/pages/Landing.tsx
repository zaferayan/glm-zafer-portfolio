...
const designs = [
  {
    ...
    description:
      "Code-focused aesthetic with terminal vibes and developer-first design",
    theme: "dark",
  },
  {
    id: 2,
    ...
    description:
      "Clean, sophisticated portfolio with elegant typography and whitespace",
    theme: "light",
  },
  {
    id: 3,
    title: "AI Futurist",
    description:
      "Modern AI-powered theme with gradient meshes and futuristic elements",
    theme: "dark",
  },
  {
    id: 4,
    title: "Education Hub",
    description:
      "Mentorship-focused design with approachable warmth and clarity",
    theme: "light",
  },
  {
    id: 5,
    title: "Bold Creative",
    description:
      "Experimental design with bold typography and unconventional layouts",
    theme: "dark",
  },
];
